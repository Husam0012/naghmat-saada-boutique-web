      ...
      <div className="container mx-auto max-w-4xl">
        <div className="bg-gradient-to-l from-primary/10 to-secondary/10 rounded-2xl p-8 md:p-12 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground mb-8">اشتركي في قناة واتساب لمتجرك ستور  واحصلي على آخر العروض والخصومات مباشرة</p>
            <div className="flex justify-center">
              <Button onClick={handleWhatsAppRedirect} className="w-full sm:w-auto px-8 py-3 text-lg font-semibold bg-[#25D366] hover:bg-[#20BA5C] transition-colors" size="lg">
                انضم إلى القناة
              </Button>
            </div>
          </div>
