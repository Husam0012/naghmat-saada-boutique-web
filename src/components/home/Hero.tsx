...
const Hero = () => {
  return (
    <section className="py-16 px-4 md:px-8 lg:px-16 bg-gradient-to-l from-[#FDE5EC] to-[#FEF7CD] overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 text-center md:text-right md:pl-8">
            ...
            <h2 className="text-xl md:text-2xl mb-6 text-foreground/80">
              تسوقي بأناقة واستمتعي بتجربة فريدة
            </h2>
            <p className="text-lg mb-8 text-muted-foreground">
              أحدث المنتجات النسائية العصرية بتصاميم أنيقة وجودة عالية
            </p>
